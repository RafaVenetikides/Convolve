...
enum ImageUtils {
    ...
    static func loadARGBFFFFBuffer(assetName: String) -> (buffer: [Float], width: Int, height: Int, original: UIImage)? {
            guard let uiImage = UIImage(named: assetName),
                  let cgImage = uiImage.cgImage else { return nil }
    ...
    static func makeARGBFFFFCGImage(buffer: [Float], width: Int, height: Int) -> CGImage? {
